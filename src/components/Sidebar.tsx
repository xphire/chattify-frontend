...
const Sidebar = () => {
	...
	return (
		<aside className='h-full border-r border-base-300 flex flex-col transition-all duration-200 overflow-y-scroll'>
			<div className='border-b border-base-300 w-full p-5'>
				...
				<div className='hidden md:flex mt-3 items-center gap-2'>
